...
def play_sound_for_duration(duration_min):
    pygame.mixer.music.load("acoustic_guitar.wav")
...
start_button = Button(text="Start", highlightthickness=0, bg=YELLOW, activebackground=YELLOW, relief=FLAT,
                      command=start_timer, font=(FONT_NAME, 10))  # Smaller font
start_button.grid(column=0, row=2, pady=(20, 0))  # Added padding

pause_button = Button(text="Pause", highlightthickness=0, bg=YELLOW, activebackground=YELLOW, relief=FLAT,
                      font=(FONT_NAME, 10))  # Smaller font
pause_button.grid(column=1, row=2, pady=(20, 0))  # Added padding
pause_button.bind('<Button-1>', pause_timer)  # Use single click

reset_button = Button(text="Reset", highlightthickness=0, bg=YELLOW, activebackground=YELLOW, relief=FLAT,
                      command=reset_timer, font=(FONT_NAME, 10))  # Smaller font
